...
public class Line implements Comparable<Line>, Iterable<Point> {
   ...
   public Line(Collection<Point> c) {
      ...
      if (line.isEmpty()) {
         throw new IllegalArgumentException("Line collection is empty");
      }
   }
   ...
   public int compareTo(Line that) {
      if (this.line.size() == 0 && that.line.size() == 0) {
         return 0;
      }
      else if (this.line.size() == 0 && that.line.size() != 0) {
         return -1;
      }
      else if (this.line.size() != 0 && that.line.size() == 0) {
         return 1;
      }
      else if (this.line.first().compareTo(that.line.first()) > 0) {
         return 1;
      } 
      else if (this.line.first().compareTo(that.line.first()) < 0) {
         return -1;
      }
      else if (this.line.last().compareTo(that.line.last()) > 0) {
         return 1;
      }
      else if (this.line.last().compareTo(that.line.last()) < 0) {
         return -1;
